...
-- Shows the total number of people who have recieved at least one COVID Vaccine till date 
...
-- Shows the total number of people who have recieved at least one COVID Vaccine till date (using a Window Function)  
...
-- Shows the Percentage of the Population who have recieved at least one COVID Vaccine till date (using CTE) 
...
-- Shows the Percentage of the Population who have recieved at least one COVID Vaccine till date (using a Temporary Table) 
